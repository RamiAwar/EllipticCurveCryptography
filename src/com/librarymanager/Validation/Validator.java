package com.librarymanager.validation;
...
public class Validator {
    ...
    public Validator(Label label, JFXTextField textField, String message){
        ...
        setupAnimation(textField);

        textField.getValidators().add(textValidator);
        updateLabel(message);

        label.setGraphic(new Icon(AwesomeIcon.WARNING,"1em",";","error"));
    ...
    public Validator(Label label, JFXPasswordField textField, String message){
        ...
        updateLabel(message);
        textValidator.setIcon(new Icon(AwesomeIcon.WARNING,"1em",";","error"));
